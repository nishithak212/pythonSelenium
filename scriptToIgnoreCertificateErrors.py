...
#Way for selenium to handle certificate errors
chrome_options.add_argument("--ignore-certificate-errors")


service_obj = Service("C:/Users/nishi/Documents/chromedriver-win64/chromedriver-win64/chromedriver.exe")
driver=webdriver.Chrome(service=service_obj, options=chrome_options) #We also mention chrome options here to tell the browser we are running headless mode and ignore cert errors
